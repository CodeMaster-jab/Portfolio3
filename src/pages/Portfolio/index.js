      ...
      <div className="container content mt-4">
        ...
        <div className="row mt-2">
          <div className="col-12 col-md-4">
            <img className='myPicture img-fluid' src="./images/MeBenji.jpg" alt=""/>
          </div>
        ...
        <div className="row">
          ...
          <div className="col-md-6">
            <p>Links:</p>
            <ul id="Links">
              <li><a href="https://drive.google.com/file/d/1zu9NM_kB6YrpX1rEqLtzEz8f4rvMbg2S/view?usp=sharing" target="_blank" rel="noopener noreferrer">Resume</a></li>
              <li><a href="https://github.com/CodeMaster-jab" target="_blank"rel="noopener noreferrer" >GitHub Profile</a></li>
              <li><a href="https://www.linkedin.com/in/jeff-bell-573a4711/" target="_blank" rel="noopener noreferrer">LinkedIn Profile</a></li>
            </ul>
          </div>
        </div>
      </div>
